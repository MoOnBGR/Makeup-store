...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                'category_id' => $labiales->id,
                'name' => 'Labial Mate Borgoña',
                'description' => 'Labial mate en tono borgoña intenso. Perfecto para ocasiones especiales.',
                'price' => 14200,
                'stock' => 15,
                'is_featured' => false,
                'image_url' => 'labial-borgona.jpg',
            ],
            [
                'category_id' => $labiales->id,
                'name' => 'Labial Brillante Fresa',
                'description' => 'Labial brillante en tono fresa. Aroma dulce y textura jugosa.',
                'price' => 11500,
                'stock' => 25,
                'is_featured' => false,
                'image_url' => 'labial-fresa.jpg',
            ],
            [
                'category_id' => $labiales->id,
                'name' => 'Labial Líquido Duradero',
                'description' => 'Labial líquido de larga duración. Acabado mate que resiste hasta 12 horas.',
                'price' => 13500,
                'stock' => 20,
                'is_featured' => false,
                'image_url' => 'labial-duradero.jpg',
            ],
            [
                'category_id' => $labiales->id,
                'name' => 'Labial Cremoso Rosa',
                'description' => 'Labial cremoso en tono rosa. Textura suave y acabado satinado.',
                'price' => 12500,
                'stock' => 22,
                'is_featured' => false,
                'image_url' => 'labial-rosa-cremoso.jpg',
            ],
            [
                'category_id' => $labiales->id,
                'name' => 'Labial Mate Durazno',
                'description' => 'Labial mate en tono durazno. Color cálido y natural para el día a día.',
                'price' => 11800,
                'stock' => 28,
                'is_featured' => false,
                'image_url' => 'labial-durazno.jpg',
            ],
            [
                'category_id' => $labiales->id,
                'name' => 'Labial Brillante Cereza',
                'description' => 'Labial brillante en tono cereza. Color vibrante y efecto jugoso.',
                'price' => 12800,
                'stock' => 20,
                'is_featured' => false,
                'image_url' => 'labial-cereza.jpg',
            ],
            [
                'category_id' => $labiales->id,
                'name' => 'Bálsamo Labial con Color Frambuesa',
                'description' => 'Bálsamo labial con color frambuesa. Hidratación y un toque de color natural.',
                'price' => 8200,
                'stock' => 30,
                'is_featured' => false,
                'image_url' => 'balsamo-frambuesa.jpg',
            ],
            [
                'category_id' => $facial->id,
                'name' => 'Contorno de Ojos Iluminador',
                'description' => 'Ilumina la mirada. Reduce ojeras y bolsas de los ojos.',
                'price' => 24500,
                'stock' => 10,
                'is_featured' => false,
                'image_url' => 'contorno-iluminador.jpg',
            ],
            [
                'category_id' => $facial->id,
                'name' => 'Crema de Noche Reparadora',
                'description' => 'Repara y regenera la piel durante la noche. Despierta con una piel renovada.',
                'price' => 19500,
                'stock' => 18,
                'is_featured' => false,
                'image_url' => 'crema-noche.jpg',
            ],
            [
                'category_id' => $facial->id,
                'name' => 'Gel Limpiador Facial',
                'description' => 'Limpia profundamente la piel. Elimina impurezas y exceso de grasa.',
                'price' => 8500,
                'stock' => 30,
                'is_featured' => false,
                'image_url' => 'gel-limpiador.jpg',
            ],
            [
                'category_id' => $facial->id,
                'name' => 'Mascarilla de Arcilla',
                'description' => 'Purifica y desintoxica la piel. Ideal para pieles con tendencia acneica.',
                'price' => 12000,
                'stock' => 20,
                'is_featured' => false,
                'image_url' => 'mascarilla-arcilla.jpg',
            ],
            [
                'category_id' => $facial->id,
                'name' => 'Sérum Facial Hidratante',
                'description' => 'Hidratación profunda con ácido hialurónico. Piel luminosa y rejuvenecida.',
                'price' => 23000,
                'stock' => 12,
                'is_featured' => false,
                'image_url' => 'serum-hidratante.jpg',
            ],
            [
                'category_id' => $facial->id,
                'name' => 'Crema Hidratante Ligera',
                'description' => 'Crema ligera de rápida absorción. Ideal para pieles mixtas y grasas.',
                'price' => 16500,
                'stock' => 22,
                'is_featured' => false,
                'image_url' => 'crema-ligera.jpg',
            ],
            [
                'category_id' => $facial->id,
                'name' => 'Exfoliante Facial Suave',
                'description' => 'Exfolia suavemente la piel. Elimina células muertas sin irritar.',
                'price' => 9200,
                'stock' => 25,
                'is_featured' => false,
                'image_url' => 'exfoliante-suave.jpg',
            ],
            [
                'category_id' => $ojos->id,
                'name' => 'Lápiz de Ojos Marrón',
                'description' => 'Lápiz de ojos en tono marrón. Textura suave y fácil de difuminar.',
                'price' => 7500,
                'stock' => 35,
                'is_featured' => false,
                'image_url' => 'lapiz-marron.jpg',
            ],
            [
                'category_id' => $ojos->id,
                'name' => 'Lápiz de Ojos Negro Intenso',
                'description' => 'Lápiz de ojos en tono negro. Trazo intenso y resistente al agua.',
                'price' => 7200,
                'stock' => 40,
                'is_featured' => false,
                'image_url' => 'lapiz-negro.jpg',
            ],
            [
                'category_id' => $ojos->id,
                'name' => 'Paleta de Sombras Tierra',
                'description' => '12 tonos tierra y marrones. Para looks naturales y elegantes.',
                'price' => 22500,
                'stock' => 12,
                'is_featured' => false,
                'image_url' => 'paleta-tierra.jpg',
            ],
            [
                'category_id' => $ojos->id,
                'name' => 'Máscara de Pestañas Alargadora',
                'description' => 'Alarga y define las pestañas. Fórmula resistente al agua.',
                'price' => 14800,
                'stock' => 20,
                'is_featured' => false,
                'image_url' => 'mascara-alargadora.jpg',
            ],
            [
                'category_id' => $ojos->id,
                'name' => 'Delineador Líquido Marrón',
                'description' => 'Delineador líquido en tono marrón. Trazo preciso y de larga duración.',
                'price' => 8900,
                'stock' => 30,
                'is_featured' => false,
                'image_url' => 'delineador-marron.jpg',
            ],
            [
                'category_id' => $ojos->id,
                'name' => 'Paleta de Sombras Rosadas',
                'description' => '9 tonos rosados y malva. Para looks románticos y juveniles.',
                'price' => 20500,
                'stock' => 10,
                'is_featured' => false,
                'image_url' => 'paleta-rosada-nueva.jpg',
            ],
            [
                'category_id' => $ojos->id,
                'name' => 'Lápiz de Cejas Marrón',
                'description' => 'Lápiz para cejas en tono marrón. Fija y define las cejas.',
                'price' => 6800,
                'stock' => 35,
                'is_featured' => false,
                'image_url' => 'lapiz-cejas.jpg',
            ],
            [
                'category_id' => $sets->id,
                'name' => 'Set de Brochas Básicas',
                'description' => 'Set de 6 brochas básicas para maquillaje. Ideales para principiantes.',
                'price' => 18500,
                'stock' => 12,
                'is_featured' => false,
                'image_url' => 'set-brochas-basicas.jpg',
            ],
            [
                'category_id' => $sets->id,
                'name' => 'Set de Cuidado Facial Completo',
                'description' => 'Set con sérum, crema de día y crema de noche. Rutina completa.',
                'price' => 42000,
                'stock' => 6,
                'is_featured' => false,
                'image_url' => 'set-cuidado-facial-completo.jpg',
            ],
            [
                'category_id' => $sets->id,
                'name' => 'Set de Viaje Labiales',
                'description' => 'Set con 3 labiales en diferentes tonos. Ideal para llevar a cualquier parte.',
                'price' => 25000,
                'stock' => 10,
                'is_featured' => false,
                'image_url' => 'set-viaje-labiales.jpg',
            ],
            [
                'category_id' => $sets->id,
                'name' => 'Set de Regalo Lujo',
                'description' => 'Set de lujo con productos exclusivos. Incluye brocha, labial y paleta.',
                'price' => 55000,
                'stock' => 4,
                'is_featured' => false,
                'image_url' => 'set-lujo-2.jpg',
            ],
            [
                'category_id' => $corporal->id,
                'name' => 'Gel de Ducha Aromático',
                'description' => 'Gel de ducha con aroma a flores blancas. Limpia y perfuma la piel.',
                'price' => 6500,
                'stock' => 40,
                'is_featured' => false,
                'image_url' => 'gel-ducha.jpg',
            ],
            [
                'category_id' => $corporal->id,
                'name' => 'Aceite de Masaje Relajante',
                'description' => 'Aceite de masaje con aroma a lavanda. Relaja y suaviza la piel.',
                'price' => 13000,
                'stock' => 18,
                'is_featured' => false,
                'image_url' => 'aceite-masaje.jpg',
            ],
            [
                'category_id' => $corporal->id,
                'name' => 'Crema Corporal Hidratante',
                'description' => 'Hidrata y nutre la piel. Textura ligera de rápida absorción.',
                'price' => 9500,
                'stock' => 25,
                'is_featured' => false,
                'image_url' => 'crema-corporal.jpg',
            ],
            [
                'category_id' => $corporal->id,
                'name' => 'Exfoliante Corporal de Café',
                'description' => 'Exfolia y revitaliza la piel. Con granos de café y aceites naturales.',
                'price' => 8200,
                'stock' => 20,
                'is_featured' => false,
                'image_url' => 'exfoliante-cafe.jpg',
            ],
            [
                'category_id' => $unas->id,
                'name' => 'Esmalte Color Rosa',
                'description' => 'Esmalte en tono rosa. Acabado brillante y duradero.',
                'price' => 6800,
                'stock' => 30,
                'is_featured' => false,
                'image_url' => 'esmalte-rosa.jpg',
            ],
            [
                'category_id' => $unas->id,
                'name' => 'Esmalte Color Rojo',
                'description' => 'Esmalte en tono rojo intenso. Acabado brillante.',
                'price' => 6800,
                'stock' => 30,
                'is_featured' => false,
                'image_url' => 'esmalte-rojo.jpg',
            ],
            [
                'category_id' => $unas->id,
                'name' => 'Top Coat Brillante',
                'description' => 'Top coat que prolonga la duración del esmalte. Brillo intenso.',
                'price' => 6200,
                'stock' => 35,
                'is_featured' => false,
                'image_url' => 'top-coat.jpg',
            ],
            [
                'category_id' => $unas->id,
                'name' => 'Esmalte Color Nude',
                'description' => 'Esmalte en tono nude. Acabado brillante y natural.',
                'price' => 6800,
                'stock' => 30,
                'is_featured' => false,
                'image_url' => 'esmalte-nude.jpg',
            ],
            [
                'category_id' => $capilar->id,
                'name' => 'Shampoo para Cabello Seco',
                'description' => 'Hidrata y restaura el cabello seco. Fórmula con aceites naturales.',
                'price' => 8800,
                'stock' => 25,
                'is_featured' => false,
                'image_url' => 'shampoo-seco.jpg',
            ],
            [
                'category_id' => $capilar->id,
                'name' => 'Acondicionador para Cabello Dañado',
                'description' => 'Repara el cabello dañado. Fórmula con queratina y aceites esenciales.',
                'price' => 9500,
                'stock' => 22,
                'is_featured' => false,
                'image_url' => 'acondicionador-danado.jpg',
            ],
            [
                'category_id' => $capilar->id,
                'name' => 'Mascarilla Capilar Nutritiva',
                'description' => 'Nutre y revitaliza el cabello. Deja el cabello suave y brillante.',
                'price' => 14800,
                'stock' => 15,
                'is_featured' => false,
                'image_url' => 'mascarilla-capilar-nutritiva.jpg',
            ],
            [
                'category_id' => $capilar->id,
                'name' => 'Sérum Capilar Sin Encrespamiento',
                ...
                'stock' => 20,
                'is_featured' => false,
                'image_url' => 'serum-encrespamiento-2.jpg',
            ],
        ];
